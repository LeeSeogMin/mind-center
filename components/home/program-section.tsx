        ...
        <div className="flex justify-center gap-4 md:gap-6">
          {PROGRAMS.map((item) => {
            ...
            return (
              ...
              >
                <div
                  className="flex h-36 w-36 md:h-40 md:w-40 flex-col items-center justify-center rounded-full text-white shadow-lg gap-1 transition-colors border-[9px] border-[#C4A870]"
                ...
                >
                  ...
                  <span className="text-xs leading-tight text-center whitespace-pre-line text-white/90">
                    {item.desc}
                  </span>
                </div>
              </Link>
