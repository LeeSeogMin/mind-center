...
export default function AdminNewsEditPage() {
  ...
  const fetchNews = useCallback(async () => {
    ...
    setEndsAt(data.ends_at ? data.ends_at.split("T")[0] : "");
    setLoading(false);
  }, [newsId, router]);
  ...
  return (
    <div className="p-6 md:p-10">
      <h1 className="font-heading text-2xl font-bold text-[#3A2E26] mb-8">소식 수정</h1>

      <Card className="border-[#E8DDD0] rounded-2xl max-w-[800px]">
        <CardHeader>
          <CardTitle className="font-heading text-xl">소식 수정</CardTitle>
        </CardHeader>
        <CardContent>
