...
export default function ReservationCTA() {
  return (
    <section className="bg-[#4A8C5E]">
      <div className="max-w-[1200px] mx-auto px-6 py-16 md:py-20">
        <div className="flex flex-col items-center text-center space-y-6">
          <h2 className="font-heading text-2xl md:text-3xl font-bold text-white">
            지금 바로 예약하세요
          </h2>
          <p className="text-[#D0E8D8] max-w-md leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-2">
            <Link
              ...
              className="inline-flex items-center justify-center rounded-xl bg-[#4A85D4] px-8 py-3.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[#C07348] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
            >
              대면상담 예약
            </Link>
            <Link
